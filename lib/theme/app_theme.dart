...
class AppTheme {
  ...
  static const Color secondaryVariantLight = Color(0xFFE8F0EA);
  static const Color accentLight =
      Color(0xFFD4AF37); // Traditional Islamic gold
  static const Color backgroundLight = Color(0xFFF4F7F5);
  static const Color surfaceLight = Color(0xFFFFFFFF); // Pure white
  static const Color errorLight = Color(0xFFE57373); // Softened red
  static const Color successLight = Color(0xFF4CAF50); // Material green
  static const Color warningLight = Color(0xFFFF9800); // Gentle amber
  ...
  static const Color secondaryVariantDark = Color(0xFF1E1E1E);
  ...
  // Shadow colors - subtle elevation system (max 4dp)
  static const Color shadowLight = Color(0x0A000000);
  static const Color shadowDark = Color(0x0AFFFFFF);

  // Divider colors - purposeful definition
  ...
  /// Light theme with Islamic minimalism design principles
  ...
  /// Dark theme with Islamic minimalism design principles
  ...
  static const Color completionGold = accentLight;
  static const Color reminderGreen = primaryLight;
  ...
  /// Elevation values following subtle elevation system (max 4dp)
